    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "admin.user.admin.index" */'../views/admin/index.vue')
            },
            {
                path: 'admin/user/admin/store',
                name: 'admin.user.admin.store',
                meta: {
                    title: 'Create Admin',
                    requireAuth: true
                },
                component: () => import(/* webpackChunkName: "admin.user.admin.store" */'../views/admin/create.vue')
            },
            {
                path: 'admin/user',
